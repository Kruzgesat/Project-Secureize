    ...
    while (1)
    {
        ...
        if (current_ui == MAIN_UI)
        {
            ...
            case '1':
                ...
                q_load(10, "Q_Beginner.CSV");
                break;

            case '2':
                strcpy(user.difficulty, "INTERMEDIATE");
                q_load(10, "Q_Intermediate.CSV");
                break;

            case '3':
                strcpy(user.difficulty, "EXPERT");
                q_load(10, "Q_Expert.CSV");
                break;
...
void quiz_ui()
{
    ...
    strcpy(question_str, questions[q_index].q_text);
    ...
    sprintf(select1_str, "A. %s", questions[q_index].a_text);
    ...
    sprintf(select2_str, "B. %s", questions[q_index].b_text);
    ...
    sprintf(select3_str, "C. %s", questions[q_index].c_text);
    ...
    sprintf(select2_str, "D. %s", questions[q_index].d_text);
